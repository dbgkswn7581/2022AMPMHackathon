package com.example.dropfood.mainscr.community;
...
public class GroupChat extends AppCompatActivity {
    ...
    private void instantiateWebSocket() {
        ...
        Request request = new Request.Builder().url("ws://1.250.219.68:8080").build();
    ...
    public class SocketListener extends WebSocketListener {
        ...
        public GroupChat activity;



        public SocketListener(GroupChat activity) {
    ...
    public class MessageAdapter extends BaseAdapter {
        ...
        public View getView(int i, View view, ViewGroup viewGroup) {
            ...
            if (view == null)
                view = getLayoutInflater().inflate(R.layout.message_list_item_groupchat, viewGroup, false);
